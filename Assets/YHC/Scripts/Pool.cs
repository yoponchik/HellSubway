...
// intense function since (1) it's static (2) it's using generics

public class Pool     // Pool doesn't inherit from Monobehaviour
{
...
public class ProjectilePool : Pool
{
    ...
    // toggling all of the projectiles on & off <= used when reloading
